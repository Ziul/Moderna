...
\begin{lstlisting}[basicstyle=\ttfamily,numbers=none,caption={[exemplo]Código de exemplo}]  % Assim fica de um tamanho aceitavel e sem os números das linhas do lado
	startup(9600);
