...
\ref{main_py}, onde haverá a inclusão de alguns  comentários no código e interação com o usuário. No programa final, parte do conteúdo impresso na tela é feito através da biblioteca curses, com o objetivo de tornar o programa mais intuitivo para o usuário e ter maior controle do fluxo de saída do programa. Assim sendo, muitos dos trechos citados nesta sessão, terão em sua versão final, em Listing \ref{main_py}, o uso do método
